...
from MaintenanceTrackerAPI.api.v1.users.single_user_single_request import SingleUserSingleRequest
...
users_ns.add_resource(SingleUserSingleRequest, '/<int:user_id>/requests/<int:request_id>',
