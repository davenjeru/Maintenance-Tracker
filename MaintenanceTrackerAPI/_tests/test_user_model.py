...
class UserBaseTestCase(unittest.TestCase):
    def setUp(self):
        users_list.clear()
        self.arguments = dict(email='email@company.com', password='password.Pa55word',
                              security_question='What is your favourite company?',
    ...
    def expect_user_transaction_error(self, expected_error_message: str, the_callable: callable, arguments: dict):
        """
        ...
        with self.assertRaises(UserTransactionError) as a:
            the_callable(arguments['email'], arguments['password'],
                         arguments['security_question'], arguments['security_answer'])
...
class ModelsTestCase(UserBaseTestCase):
    ...
    def test_create_user_with_wrong_email_syntax(self):
        ...
        self.expect_user_transaction_error(expected_error_message, User, self.arguments)
    ...
    def test_create_user_with_wrong_security_question_syntax(self):
        ...
        expected_error_message = 'security question must start with a \'Wh\' or a \'Are\' question'
        self.expect_user_transaction_error(expected_error_message, User, self.arguments)
    ...
    def test_create_user_with_wrong_security_answer_syntax(self):
        ...
        expected_error_message = 'security answer must not contain any punctuations'
        self.expect_user_transaction_error(expected_error_message, User, self.arguments)
